...
Each load module is connected to the EMU through a power gate (PG). 
...
% Final conclusion?
% In conclusion, this thesis has presented extensive research work towards the energy budgeting for efficient operation of IPSs.
