...
With \nn{}, the IPS is able to automatically adjust its voltage threshold to runtime variable operating conditions, dispelling the need for manual energy profiling of atomic tasks and improving performance by the just sufficient dynamic threshold.
}