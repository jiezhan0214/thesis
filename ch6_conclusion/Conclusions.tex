...
To manage energy, the MCU typically interfaces with energy monitoring hardware in the forms of an ADC~\cite{sliper2019efficient}, a voltage comparator~\cite{kang2018homerun, balsamo2016hibernus++}, or an energy management unit (EMU)~\cite{gomez2016dynamic, maeng2019supporting}.
The processor should not only execute the application program but also take care of the system's stored energy and computing state. 
...
Advantages: low quiescent current.
