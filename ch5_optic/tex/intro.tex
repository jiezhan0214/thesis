...
\begin{enumerate}
    ...
    \item Implementation of the proposed runtime energy profiling and threshold adaptation method, with an efficient supply voltage monitor (\sref{sec:implementation}).
\end{enumerate}