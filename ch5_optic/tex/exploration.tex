...
The voltage-time charging trace is then differentiated to gain an I-V curve that represents the PV panel (Figure~\ref{fig:pv_iv} \fref{fig:pv_iv}). 
...
\begin{equation}
    ...
    \label{eq:pv_iv}
\end{equation}
%which matches with the operating voltage range of the MCU, such that the power supply in simulation has a linearly-scaling supply current with the operating voltage.
