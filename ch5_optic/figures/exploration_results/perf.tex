\begin{figure}
    ...
    \begin{groupplot}[
        ...
        xbar,
        symbolic y coords={debsl,samoyed,debsh,adaptive},
        xmin=0,
        ...
        \nextgroupplot[xmax=120,xlabel={No. of Completions}]
        \addplot
        ...
        \node [anchor=west, font=\footnotesize, Set1-A] at (axis cs:0,debsh) {0};
        \node [anchor=west, font=\footnotesize, black] at (axis cs:0,debsl) {Non-Termination};

    \end{groupplot}
    \end{tikzpicture}
    \caption{Numbers of completed and failed operations among four control schemes given random data sizes and configurations and a PV supply. }
