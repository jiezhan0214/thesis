\begin{figure}
    ...
    \end{groupplot}
    \end{tikzpicture}
    \caption{Numbers of completed and failed operations of Samoyed, \debs{}, and Adaptive given random data sizes and configurations and a PV supply in a \SI{10}{\second} simulation. }
