...
This chapter first provides a background of various ambient energy sources and corresponding energy harvesters in \sref{sec:eh}, as well as the types of energy storage used in energy-harvesting systems in \sref{sec:es}. 
Energy-neutral operation, a traditional design of energy-harvesting systems, is reviewed in \sref{sec:en}. 
Finally, the recent research towards IPSs is reviewed in \sref{sec:ips} with an illustration of proposed methodologies.
