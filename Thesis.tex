...
% \title      {Energy-Storage and -Harvester Sizing in Energy-Driven Computing}
\title       {Efficient Energy Designs for Energy-Harvesting Intermittent Systems}
...
% Chapter 1
\include{ch1_intro/Introduction}

% Chapter 2
\include{ch2_review/Review}


% Chapter 3
% \include{Work1}
% \include{CapSizing/CapSizing}
% \include{Work2}
\include{ch3_sizingeffect/SizingEffect}

% Chapter 4
\include{ch4_sizingapproach/SizingApproach}

% Chapter 5
\include{ch5_repta/REPTA}

% Chapter 6
\include{ch6_conclusion/Conclusions}

% \include{CapSizing/paper}
