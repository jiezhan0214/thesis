...
\begin{figure}[!t]
    ...
    % \hfil
    \includegraphics[width=0.85\columnwidth]{ch4_sizingapproach/figures/IntPeriodOrdFig}
...
% \begin{figure}[!t]
%     \centering
%     \subfloat[EnHANTs Setup A]{\includegraphics[width=1.65in]{HarvStorRan2Fig1}
%     \label{fig:harvstorrange1}}
%     \subfloat[EnHANTs Setup D]{\includegraphics[width=1.65in]{HarvStorRan2Fig2}
%     \label{fig:harvstorrange2}}
%     \hfil
%     \subfloat[NREL Denver 2018]{\includegraphics[width=1.65in]{HarvStorRan2Fig3}
%     \label{fig:harvstorrange3}}
%     \subfloat[NREL Hawaii 2018]{\includegraphics[width=1.65in]{HarvStorRan2Fig4}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.85\columnwidth]{ch4_sizingapproach/figures/CapVol2Fig2}
